/* Vigilia — operación: alertas, incidentes, visitas y reportes. */
(function () {
  'use strict';
    ...
    return {
      ...
      mount(root) {
        ...
        const paint = () => {
          ...
          sheet.innerHTML = '<div class="rs-head"><div>' + CN.logoTile(34) + '<b>Vigilia</b></div><div class="rs-meta"><b>Reporte de mantenimiento preventivo</b><span>' + esc(b.name) + ' · ' + esc(b.address) + '</span><span>' + label + ' · Generado el ' + CN.fmtDate(Date.now()) + '</span></div></div>' +
